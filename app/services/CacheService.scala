...
import configdata.Category.CategoryTree
...
case class SignupRequestKey(token: String) extends
    CacheKey[(SignupSolicitude, SignupCredentials, Seq[String])](60 * 15) {
  override def toString: String = "SignupRequestKey." + token
}

case class ClearPassRequestKey(token: String) extends
    CacheKey[(ClearPassSolicitud, SignupCredentials, String)](60 * 15) {
  override def toString: String = "ClearPassRequestKey." + token
}

object Keys {
  val biomaterialType: CacheKey[Seq[BioMaterialType]] = new CacheKey[Seq[BioMaterialType]] {
    override def toString: String = "Keys.biomaterialType"
  }
  val crimeType: CacheKey[Seq[CrimeType]] = new CacheKey[Seq[CrimeType]] {
    override def toString: String = "Keys.crimeType"
  }
  val categoryTree: CacheKey[CategoryTree] = new CacheKey[Category.CategoryTree] {
    override def toString: String = "Keys.categoryTree"
  }
  val categoryTreeManualLoading: CacheKey[CategoryTree] = new CacheKey[Category.CategoryTree] {
    override def toString: String = "Keys.categoryTreeManualLoading"
  }
  val categories: CacheKey[Map[AlphanumericId, FullCategory]] = new CacheKey[Map[AlphanumericId, FullCategory]] {
    override def toString: String = "Keys.categories"
  }
  val laboratories: CacheKey[Seq[Laboratory]] = new CacheKey[Seq[Laboratory]] {
    override def toString: String = "Keys.laboratories"
  }
  val countries: CacheKey[Seq[Country]] = new CacheKey[Seq[Country]] {
    override def toString: String = "Keys.countries"
  }
  val provinces: CacheKey[Seq[Province]] = new CacheKey[Seq[Province]] {
    override def toString: String = "Keys.provinces"
  }
  val strKits: CacheKey[Seq[FullStrKit]] = new CacheKey[Seq[FullStrKit]] {
    override def toString: String = "Keys.strKits"
  }
  val locus: CacheKey[Seq[FullLocus]] = new CacheKey[Seq[FullLocus]] {
    override def toString: String = "Keys.locus"
  }
  val analysisTypes: CacheKey[Seq[AnalysisType]] = new CacheKey[Seq[AnalysisType]] {
    override def toString: String = "Keys.analysisTypes"
  }
  val caseTypes: CacheKey[Seq[CaseType]] = new CacheKey[Seq[CaseType]] {
    override def toString: String = "Keys.caseTypes"
  }
  val roles: CacheKey[Seq[Role]] = new CacheKey[Seq[Role]] {
    override def toString: String = "Keys.roles"
  }
  val rolePermissionMap: CacheKey[Map[String, Set[Permission]]] = new CacheKey[Map[String, Set[Permission]]] {
