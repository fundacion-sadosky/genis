  ...
  requirejs
    .config(
      {
        ...
        packages : [
          ...
          'mutations',
          'profileExporter',
          'profileExporterToLims',
          'modifyForensicCategory'
        ],
        shim : {
          'jsRoutes' : {
            deps : [],
    ...
    require(
      ...
      function(angular) {
        ...
        var ngApp = angular.bootstrap(
          document,
          [
            'ngRoute', 'ngCookies', 'jm.i18next', 'ui.bootstrap', 'ngFileUpload',
            'ui.select', 'cfp.hotkeys','app'
          ],
          { strictDi: true }
        );
        ngApp
          .get('$rootScope')
          .$broadcast('pdg.loaded');
      }
    );
  }
)(requirejs);
