define(
	[
		...
		'./directives/pdgStatisticalOptions',
		'common'
	],
	function(
		angular,
					...
					function($routeProvider) {
						$routeProvider
							.when(
								'/matches',
								{
									templateUrl: '/assets/javascripts/matches/matcher-manager.html',
									controller: 'matchesController'
								}
							)
							.when(
								'/comparison/:profileId/matchedProfileId/:matchedProfileId/matchingId/:matchingId',
								{
									templateUrl: '/assets/javascripts/matches/views/comparison.html',
									controller: 'comparisonController'
								}
							)
							.when(
								'/comparison/:profileId/matchedProfileId/:matchedProfileId/matchingId/:matchingId/pedigreeMatch/:isPedigreeMatch',
								{
									templateUrl: '/assets/javascripts/matches/views/comparison.html',
									controller: 'comparisonController'
								}
							...
							.when(
								'/comparison/:profileId/matchedProfileId/:matchedProfileId/matchingId/:matchingId/collapsingMatch/:isCollapsingMatch',
								{
									templateUrl: '/assets/javascripts/matches/views/comparison.html',
									controller: 'comparisonController'
								}
