...
return {
			...
			link: function(scope, el) {
                ...
                var table = '<table style="width:100%;padding: 0px 5px 0px 5px;" cellpadding="10"><thead><th style="padding: 0px 0px 0px 15px;" class="text-center">' + $.i18n.t('generics.locus') + '</th><th style="padding: 0px 15px 0px 15px;" class="text-center">' + $.i18n.t('generics.alleles') + '</th><th style="padding: 0px 15px 0px 0px;" class="text-center">' + $.i18n.t('generics.range') + '</th></thead><tbody><tr ng:repeat="l in gen"  align="center"><td>{{l.locus}}</td><td class="text-center"><span class="text-center" ng:repeat="allele in l.alleles track by $index"> <span ng-class="{outofladder: l.isOutOfLadder(l,allele)}">{{allele}}</span></span></td><td class="text-center" style="padding: 0px 15px 0px 0px;">&nbsp;{{l.range}}</td></td></tr></tbody></table>';
