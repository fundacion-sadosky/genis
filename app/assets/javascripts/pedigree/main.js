define(
	...
	function(
		...
		angular
			...
			.controller('pedigreeController', ['$scope', '$filter', 'pedigreeService', '$routeParams', '$modal', 'statsService', 'alertService', '$timeout', '$q', '$route','$location', pedigreeController])
			...
			.controller('activarPedigreeModalController',['$scope','$modalInstance','data','mutationService',activarPedigreeModalController])
