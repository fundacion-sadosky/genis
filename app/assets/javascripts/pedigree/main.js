define(['angular', './pedigreeService', 
        './controllers/originalController', './controllers/pedigreeController',
        './controllers/disassociateController', './controllers/courtcasesController',
...
function(angular, pedigreeService, 
		originalController, pedigreeController, disassociateController, courtcasesController,
		courtcaseDataController, searchProfileModalController, scenariosDeleteModalController,
        pedigreeScenarioController, scenarioNameModalController, pedigreeScenarioReportController,
        pedigreeGenotypificationController, validateScenarioModalController, filters,common,
		courtcaseController,profileCourtcaseController,searchMultipleProfileModalController,
		searchBatchModalController, pedigreesDataController, activarPedigreeModalController,
		metadataModalController, courtCaseCloseModalController, groupedProfilesModal, matchesController,
		matchesGroupsController,pedigreeConsistencyController,pedigreeMatchesCourtCaseController) {
'use strict';
