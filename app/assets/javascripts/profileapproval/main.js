...
angular
    ...
    .controller('profileApprovalController', ['$scope', 'profileApprovalService','alertService','$q','$modal','bulkuploadService','locusService','profileService','cryptoService', '$filter', profileApprovalController])
