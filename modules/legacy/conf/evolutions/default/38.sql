...
ALTER TABLE "APP"."PROFILE_UPLOADED" ADD COLUMN "USER" VARCHAR(255);
ALTER TABLE "APP"."PROFILE_UPLOADED" ADD COLUMN "INTERCONNECTION_ERROR" VARCHAR(255);
ALTER TABLE "APP"."PROFILE_SENT" ADD COLUMN "USER" VARCHAR(255);
...
(
    ...
    "IS_CATEGORY_MODIFICATION" boolean NOT NULL DEFAULT false,
    "INTERCONNECTION_ERROR" character varying(255) COLLATE pg_catalog."default",
    CONSTRAINT "PROFILE_RECEIVED_ID_PKEY" PRIMARY KEY ("GLOBAL_CODE"),
...
ALTER TABLE "APP"."PROFILE_UPLOADED" DROP COLUMN IF EXISTS "USER";
ALTER TABLE "APP"."PROFILE_UPLOADED" DROP COLUMN IF EXISTS "INTERCONNECTION_ERROR";
ALTER TABLE "APP"."PROFILE_SENT" DROP COLUMN IF EXISTS "USER";
ALTER TABLE "APP"."PROFILE_SENT" DROP COLUMN IF EXISTS "INTERCONNECTION_ERROR";


DELETE FROM "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" WHERE "ID" IN (17, 18, 19, 20, 21, 22, 23);

UPDATE "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" SET "STATUS" = 'Previous status for ID 5' WHERE "ID" = 5;
UPDATE "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" SET "STATUS" = 'Previous status for ID 6' WHERE "ID" = 6;
