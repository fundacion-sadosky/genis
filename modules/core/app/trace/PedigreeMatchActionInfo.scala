...
case class PedigreeMatchInfo(
  ...
  override val description =
    if (courtCase.isDefined && pedigreeName.isDefined)
...
case class PedigreeDiscardInfo(
  ...
  override val description =
    if (courtCase.isDefined && pedigreeName.isDefined)
      ...
      s"Descarte del match del pedigrí $pedigree cuyo responsable es $user."
}
...
case class PedigreeConfirmInfo(
  ...
  override val description =
    if (courtCase.isDefined && pedigreeName.isDefined)
      ...
      s"Confirmación del match del pedigrí $pedigree cuyo responsable es $user."
}
