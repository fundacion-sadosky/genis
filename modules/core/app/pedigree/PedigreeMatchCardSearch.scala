...
object PedigreeMatchCardSearch:
  implicit val searchFormat: play.api.libs.json.OFormat[PedigreeMatchCardSearch] = Json.format[PedigreeMatchCardSearch]
...
object PedMatchCardSearch:
  implicit val searchFormat: play.api.libs.json.OFormat[PedMatchCardSearch] = Json.format[PedMatchCardSearch]
