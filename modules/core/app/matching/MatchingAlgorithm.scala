...
object MatchingAlgorithm {
  ...
  def getMatchLevels(
    ...
    if (loci.nonEmpty) {
      ...
      def buildMatchResult(
        gp: Profile.Genotypification,
        gq: Profile.Genotypification,
        minStringency: Stringency,
      ...
      def buildMatchResultMixMix(
        gp: Profile.Genotypification,
        gpv: Option[Profile.Genotypification],
        gq: Profile.Genotypification,
        gqv: Option[Profile.Genotypification],
        minStringency: Stringency,
        lociToMatch: Seq[Profile.Marker],
        mismatchesRemaining: Int,
        lastMap: Option[Map[Profile.Marker, Stringency]]
  ...
  def getNewMatchingResult(
    map: Map[Profile.Marker, Stringency],
    q: Profile,
    matchingRule: MatchingRule,
    pGenotype: Genotypification,
    qGenotype: Genotypification,
  ...
  def convertProfileWithoutAcceptedLocus(
    p: Profile,
