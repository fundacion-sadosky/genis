...
class ProfileDataServiceTest extends PdgSpec with MockitoSugar {
  ...
  "ProfileDataService" must {
    "delete a profile and all his matches" in {
      ...
      val mockLabService = mock[LaboratoryService]
      val mockCrimeTypeService = mock[CrimeTypeService]
      val mockScenarioRepository = mock[ScenarioRepository]
      /*val service = new ProfileDataServiceImpl(null, mockProfileDataRepository, null, connRepo, null, null, null, mockLabService, null, mockScenarioRepository, null, Stubs.traceServiceMock, Stubs.traceServiceMock, "SHDG", "AR", "C", "someProvince")
    ...
    "get a ProfileData by sampleCode" in {
      ...
      val connRepo = mock[ConnectionRepository]
      val target: ProfileDataService = new ProfileDataServiceImpl(mockCacheService, mockProfileDataRepository, mockCategoryService, connRepo,
        null, bioMatService, crimeType, labService, null, null, null, Stubs.traceServiceMock, "", "", "")
    ...
    "get several ProfileData by sampleCodes" in {
      ...
      val target: ProfileDataService = new ProfileDataServiceImpl(mockCacheService,
        mockProfileDataRepository, mockCategoryService, connRepo,
    ...
    "delete a profile - succesful" in {
      ...
      val target = new ProfileDataServiceImpl(null, profileDataRepository, null, connRepo, null, null, null, null, matchingServiceMock, scenarioRepository, profileRepo, Stubs.traceServiceMock, null, null, null,null,null,pedigreeService)
    ...
    "delete a profile - failure E0118" in {
      ...
      val target = new ProfileDataServiceImpl(null, null, null, null, null, null, null, null, null, scenarioRepository, null, Stubs.traceServiceMock, null, null, null,null,null,pedigreeService)
    ...
    "delete a profile and trace action" in {
      ...
      val target = new ProfileDataServiceImpl(null, profileDataRepository, null, null, null, null, null, null, matchingServiceMock, scenarioRepository, profileRepo, traceService, null, null, null,null,null,pedigreeService)
