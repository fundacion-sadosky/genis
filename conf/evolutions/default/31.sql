...
INSERT INTO "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" ("ID", "STATUS") VALUES (13, 'Delete pendiente de envío a instancia inferior');
INSERT INTO "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" ("ID", "STATUS") VALUES (14, 'Delete Enviado a instancia inferior');
...
DELETE FROM "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" WHERE "ID" = 13;
DELETE FROM "APP"."INFERIOR_INSTANCE_PROFILE_STATUS" WHERE "ID" = 14;
