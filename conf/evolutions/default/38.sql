# --- !Ups
ALTER TABLE "APP"."PROFILE_UPLOADED" ADD COLUMN "DELETION_USER" VARCHAR(255);
ALTER TABLE "APP"."PROFILE_UPLOADED" ADD COLUMN "INTERCONNECTION_ERROR" VARCHAR(255);
ALTER TABLE "APP"."PROFILE_SENT" ADD COLUMN "DELETION_USER" VARCHAR(255);
...
(
    ...
    "DELETION_USER" text COLLATE pg_catalog."default",
...
# --- !Downs
ALTER TABLE "APP"."PROFILE_UPLOADED" DROP COLUMN IF EXISTS "DELETION_USER";
ALTER TABLE "APP"."PROFILE_UPLOADED" DROP COLUMN IF EXISTS "INTERCONNECTION_ERROR";
ALTER TABLE "APP"."PROFILE_SENT" DROP COLUMN IF EXISTS "DELETION_USER";
...
DROP SEQUENCE IF EXISTS "APP"."PROFILE_RECEIVED_ID_seq" CASCADE;
