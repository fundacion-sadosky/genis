...
INSERT INTO "APP"."CATEGORY_CONFIGURATION"
      ("CATEGORY", "TYPE", "COLLECTION_URI", "DRAFT_URI", "MIN_LOCUS_PER_PROFILE",
      "MAX_SHORTAGE_DEVIATED_LOCI", "MAX_OVERAGE_DEVIATED_LOCI")
SELECT "ID",
      (SELECT "ID" FROM "APP"."ANALYSIS_TYPE" WHERE "NAME" = 'Autosomal'),
      "COLLECTION_URI", "DRAFT_URI", "MIN_LOCUS_PER_PROFILE",
      "MAX_SHORTAGE_DEVIATED_LOCI", "MAX_OVERAGE_DEVIATED_LOCI"
FROM "APP"."CATEGORY";
...
DELETE FROM "APP"."CATEGORY_ASSOCIATION"
WHERE "TYPE" <> (SELECT "ID" FROM "APP"."ANALYSIS_TYPE" WHERE "NAME" = 'Autosomal');

DELETE FROM "APP"."CATEGORY_MATCHING"
WHERE "TYPE" <> (SELECT "ID" FROM "APP"."ANALYSIS_TYPE" WHERE "NAME" = 'Autosomal');
...
UPDATE "APP"."CATEGORY" AS CAT
SET "COLLECTION_URI" = CONF."COLLECTION_URI",
"DRAFT_URI" = CONF."DRAFT_URI",
"MIN_LOCUS_PER_PROFILE" = CONF."MIN_LOCUS_PER_PROFILE",
"MAX_SHORTAGE_DEVIATED_LOCI" = CONF."MAX_SHORTAGE_DEVIATED_LOCI",
"MAX_OVERAGE_DEVIATED_LOCI" = CONF."MAX_OVERAGE_DEVIATED_LOCI"
FROM "APP"."CATEGORY_CONFIGURATION" AS CONF
WHERE CONF."CATEGORY" = CAT."ID"
AND CONF."ID" = (SELECT "ID" FROM "APP"."ANALYSIS_TYPE" WHERE "NAME" = 'Autosomal');
